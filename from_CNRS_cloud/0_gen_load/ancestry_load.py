...
#temporal samples of TreeSeq files (according to sampling intervals done in SLiM)
gen_1 = np.arange(tadmix+Step1, fim1, Step1)
gen_2 = np.arange(timestep, fim2, Step2)
gen = np.append(gen_1, gen_2)
   
for i in gen:
    filename = run + "_" + str(i) + ".trees"
